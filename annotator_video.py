...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None, global_w=1000, global_h=1800, model_type='vit_b', keep_input_size=True, max_size=1080):
        ...
        self.button_next.move(int(0.2 * global_w), int(0.83 * global_h))
        self.button_next.resize(int(0.1 * global_w),int(0.04 * global_h))
        self.button_last.move(int(0.01 * global_w), int(0.83 * global_h))
        self.button_last.resize(int(0.1 * global_w),int(0.04 * global_h))
        self.button_next_video.resize(int(0.1 * global_w),int(0.04 * global_h))
        self.button_next_video.move(int(0.2 * global_w), int(0.9 * global_h))
        self.button_last_video.resize(int(0.1 * global_w),int(0.04 * global_h))
        self.button_last_video.move(int(0.01 * global_w), int(0.9 * global_h))
        self.class_on_text.move(int(0.01 * global_w), int(0.95 * global_h))
        ...
        self.video_progress_bar.resize(int(0.3 * global_w),int(0.04 * global_h))
